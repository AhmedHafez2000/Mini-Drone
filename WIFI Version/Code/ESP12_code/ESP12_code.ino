...
*
********************************************************************************************************/
char auth[] = "Enter the auth code";//Enter the auth code
char ssid[] = "Hotspot name";//Enter mobile Hotspot name
char pass[] = "Hotspot password";//Enter mobile Hotspot password


#define BLYNK_TEMPLATE_ID "TEMPLATE_ID"
#define BLYNK_DEVICE_NAME "Hotspot name"
#define BLYNK_AUTH_TOKEN "Enter the auth code"
...
BLYNK_WRITE(V1) //ROLL
{
 ...
 // Replace 0 and 100 to change joystich oriantaion
 Roll=map(temp,100,0,(1500-Rlimit),(1500+Rlimit));
